...
from foundations_rest_api_core.global_state import app_manager
from foundations_rest_api_core.v1.controllers.session_controller import SessionController
...
class TestSessionController(Spec):
    ...
    mock_auth = let_patch_mock('foundations_rest_api_core.v1.models.session.Session.auth')
    mock_create = let_patch_mock('foundations_rest_api_core.v1.models.session.Session.create')
    ...
    @patch('foundations_rest_api_core.response.Response.constant')
