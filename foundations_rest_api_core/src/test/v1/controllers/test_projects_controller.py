...
from foundations_rest_api_core.v1.controllers.projects_controller import ProjectsController

class TestProjectsController(unittest.TestCase):

    @patch('foundations_rest_api_core.v1.models.project.Project.all')
