...
class TestValidationReportListing(Spec):
    ...
    def test_validation_report_listing_has_monitor_package(self):
        self._test_validation_report_listing_has_property('monitor_package')
    ...
    def test_validation_report_listing_get_all_returns_singleton_when_one_report_exists_in_redis(self):
        ...
        expected_result = [
            ValidationReportListing(data_contract=self.data_contract, monitor_package=self.monitor_package, inference_period=self.inference_period)
        ]
    ...
    def test_validation_report_listing_get_all_returns_empty_list_if_no_key_matching_pattern_exists_in_redis_project_prefix_wrong(self):
        key_to_write = f'bep:{self.project_name}:monitors:{self.monitor_package}:validation:{self.data_contract}'
    ...
    def test_validation_report_listing_get_all_returns_empty_list_if_project_name_does_not_match(self):
        key_to_write = f'projects:bad_project_name:monitors:{self.monitor_package}:validation:{self.data_contract}'
        self.redis_connection.hset(key_to_write, 'whut', 'woop')
    ...
    def test_validation_report_listing_get_all_returns_empty_list_if_no_key_matching_pattern_exists_in_redis_monitors_token_wrong(self):
        key_to_write = f'projects:{self.project_name}:beetles:{self.monitor_package}:validation:{self.data_contract}'
        self.redis_connection.hset(key_to_write, 'whut', 'woop')
    ...
    def test_validation_report_listing_get_all_returns_empty_list_if_no_key_matching_pattern_exists_in_redis_validation_token_wrong(self):
        key_to_write = f'projects:{self.project_name}:monitors:{self.monitor_package}:beeble:{self.data_contract}'
        self.redis_connection.hset(key_to_write, 'whut', 'woop')
    ...
    def test_validation_report_listing_get_all_returns_empty_list_if_no_key_matching_pattern_exists_in_redis_contract_name_missing(self):
        key_to_write = f'projects:{self.project_name}:monitors:{self.monitor_package}:validation'
        self.redis_connection.hset(key_to_write, 'whut', 'woop')
    ...
    def test_validation_report_listing_get_all_returns_all_listings_when_multiple_reports_exist_in_redis_sorted_by_inference_period(self):
        ...
        expected_result = [
            ValidationReportListing(data_contract=self.data_contract_2, monitor_package=self.monitor_package_2, inference_period='2019-03-04'),
            ValidationReportListing(data_contract=self.data_contract, monitor_package=self.monitor_package, inference_period='2019-10-13')
        ]


        self.assertEqual(expected_result, promise.evaluate())

    def test_validation_report_listing_get_all_returns_all_listings_when_multiple_reports_exist_in_redis_sorted_by_inference_period_then_by_monitor_package(self):
        ...
        expected_result = [
            ValidationReportListing(data_contract=self.data_contract, monitor_package='cat_meow', inference_period='2019-10-13'),
            ValidationReportListing(data_contract=self.data_contract_2, monitor_package='dog_bark', inference_period='2019-10-13')
        ]


        self.assertEqual(expected_result, promise.evaluate())

    def test_validation_report_listing_get_all_returns_all_listings_when_multiple_reports_exist_in_redis_sorted_by_inference_period_then_by_monitor_package_then_by_data_contract(self):
        ...
        expected_result = [
            ValidationReportListing(data_contract='data_contract', monitor_package='cat_meow', inference_period='2019-10-13'),
            ValidationReportListing(data_contract='data_contract_2', monitor_package='cat_meow', inference_period='2019-10-13')
        ]
    ...
    def test_validation_report_listing_get_all_returns_all_listings_when_there_is_a_single_report_and_contract_with_multiple_dates(self):
        ...
        expected_result = [
            ValidationReportListing(data_contract='data_contract', monitor_package='cat_meow', inference_period='2019-03-04'),
            ValidationReportListing(data_contract='data_contract', monitor_package='cat_meow', inference_period='2019-10-13')
        ]
