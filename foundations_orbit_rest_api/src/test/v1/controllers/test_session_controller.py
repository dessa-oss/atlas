...
from foundations_orbit_rest_api.v1.controllers.session_controller import SessionController
...
class TestSessionController(Spec):
    ...
    mock_auth = let_patch_mock('foundations_orbit_rest_api.v1.models.session.Session.auth')
    mock_create = let_patch_mock('foundations_orbit_rest_api.v1.models.session.Session.create')
    ...
    @patch('foundations_orbit_rest_api.response.Response.constant')
