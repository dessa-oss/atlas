...
def _project_listing_implementation(result_end_point):
    ...
    return project_listing_implementation(
        result_end_point, DeploymentSSHBucket.bucket_from_single_path
    )
...
def _archive_listing_implementation(result_end_point):
    ...
    return archive_listing_implementation(
        result_end_point, DeploymentSSHBucket.bucket_from_single_path
    )
...
def _worker_container_overrides(config):
    return {"worker_container_overrides": config["worker"]}
