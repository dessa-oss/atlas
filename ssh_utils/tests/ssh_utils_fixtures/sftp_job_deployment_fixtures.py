...
class MockDeployment(SFTPJobDeployment):
    def __init__(self, *args, **kwargs):
        pass

# queued

class QueuedMockDeployment(MockDeployment):
...
class RunningMockDeployment(MockDeployment):
    def _is_job_queued(self):
        return False

class NeverFinishDeployment(RunningMockDeployment):
    def is_job_complete(self):
        return False

class SuccessfulMockDeployment(RunningMockDeployment):
    def is_job_complete(self):
        return True
...
class FailedMockDeployment(RunningMockDeployment):
    def is_job_complete(self):
        return True
