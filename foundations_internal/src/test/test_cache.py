...
class TestCache(unittest.TestCase):
    ...
    def test_get_metadata_option_object_exists_metadata_has_one_entry(self):
        ...
        self.backend.set(
            "cache-uuid", serialize("cached_value"), metadata_to_set)
    ...
    def test_get_metadata_option_object_exists_metadata_has_two_entries_different_object(self):
        metadata_to_set = serialize({"job_id": "asdf", "ser_vers": 3})
        self.backend.set(
            "cache-uuid2", serialize("cached_value"), metadata_to_set)
    ...
    def test_get_metadata_does_not_return_broken_data(self):
        ...
        self.assertIsNone(self.cache.get_metadata_option(
            'hello').get_or_else(None))
