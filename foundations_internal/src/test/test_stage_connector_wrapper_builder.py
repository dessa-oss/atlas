...
from foundations_internal.stage_connector_wrapper_builderimport StageConnectorWrapperBuilder
...
class TestStageConnectorWrapper(unittest.TestCase):
    ...
    def test_stage_generates_uuid(self):
        ...
        builder = StageConnectorWrapperBuilder(
            self._graph, self._pipeline_context)
