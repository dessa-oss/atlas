...
class TestBucketFromScheme(object):
    ...
    def test_artifact_end_point_returns_constructor_arguments_with_s3_scheme_and_default_relative_path(self):
        import os
        from foundations_aws.aws_bucket import AWSBucket
        ...
        self.assertEqual([AWSBucket, os.path.join(self.fake_bucket_path, 'results')], config['constructor_arguments'])

    def test_artifact_end_point_returns_constructor_arguments_with_gcp_scheme_and_default_relative_path(self):
        import os
        from foundations_gcp.gcp_bucket import GCPBucket
        ...
        result_config = self.translator.translate(self._configuration)
        config = result_config['artifact_end_point_implementation']
        self.assertEqual([GCPBucket, os.path.join(self.fake_bucket_path, 'results')], config['constructor_arguments'])
    ...
    def test_artifact_end_point_returns_constructor_arguments_with_s3_scheme(self):
        ...
        result_config = self.translator.translate(self._configuration)
        config = result_config['artifact_end_point_implementation']
        self.assertEqual([AWSBucket, os.path.join(self.fake_bucket_path, self.fake_relative_path)], config['constructor_arguments'])
    ...
    def test_artifact_end_point_returns_constructor_arguments_with_gcp_scheme(self):
        ...
        result_config = self.translator.translate(self._configuration)
        config = result_config['artifact_end_point_implementation']
        self.assertEqual([GCPBucket, os.path.join(self.fake_bucket_path, self.fake_relative_path)], config['constructor_arguments'])
