def _flattened_config_walk():
    ...
    for dir_name, _, files in os.walk('cypress/fixtures/orbit_acceptance/.foundations'):
...
def _config():
    ...
    for required_env in ['CYPRESS_LOCAL_FOUNDATIONS_HOME', 'CYPRESS_SCHEDULER_IP', 'CYPRESS_SCHEDULER_FOUNDATIONS_HOME', 'CYPRESS_SCHEDULER_REDIS_PORT', 'CYPRESS_GUI_HOST', 'CYPRESS_GUI_PORT', 'CYPRESS_PROXY_PORT']:
