...
def upload_artifacts(job_id):
    ...
    upload_artifacts_to_archiver(pipeline_archiver)

def upload_artifacts_to_archiver(pipeline_archiver):
    ...
    upload_file_listing(artifact_path, list_of_files_to_upload, pipeline_archiver)
...
def upload_file_listing(artifact_path, list_of_files_to_upload, pipeline_archiver):
