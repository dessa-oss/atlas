...
class TestPipelineContextWithArchive(unittest.TestCase):
    ...
    @patch('foundations_internal.pipeline_context.PipelineContext.load_stage_log_from_archive')
    ...
    @patch('foundations_internal.pipeline_context.PipelineContext.load_persisted_data_from_archive')
    def test_wraps_load_persisted_data_from_archive(self, mock):
        self._context.load_persisted_data_from_archive()
        mock.assert_called_with(self._archive)

    @patch('foundations_internal.pipeline_context.PipelineContext.load_provenance_from_archive')
    def test_wraps_load_provenance_from_archive(self, mock):
        self._context.load_provenance_from_archive()
        mock.assert_called_with(self._archive)

    @patch('foundations_internal.pipeline_context.PipelineContext.load_job_source_from_archive')
    def test_wraps_load_job_source_from_archive(self, mock):
        self._context.load_job_source_from_archive()
        mock.assert_called_with(self._archive)

    @patch('foundations_internal.pipeline_context.PipelineContext.load_artifact_from_archive')
    def test_wraps_load_artifact_from_archive(self, mock):
        self._context.load_artifact_from_archive()
        mock.assert_called_with(self._archive)

    @patch('foundations_internal.pipeline_context.PipelineContext.load_miscellaneous_from_archive')
    def test_wraps_load_miscellaneous_from_archive(self, mock):
        self._context.load_miscellaneous_from_archive()
        mock.assert_called_with(self._archive)

    @patch('foundations_internal.pipeline_context.PipelineContext.load_from_archive')
