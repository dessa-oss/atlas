...
class TestOrbitMonitorPackageServer(Spec):
    ...
    def set_up(self):
        ...
        mock_get_logger.return_when(self.mock_logger, 'foundations_contrib.cli.orbit_monitor_package_server')
    ...
    def test_monitor_create_logs_correct_message_when_job_scheduled(self):
        ...
        self.patch('foundations_contrib.cli.orbit_monitor_package_server._get_monitor_job_spec')
        self.patch('foundations_contrib.cli.orbit_monitor_package_server._get_monitor_gpu_spec')
