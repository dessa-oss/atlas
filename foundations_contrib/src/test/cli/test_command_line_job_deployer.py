...
class TestCommandLineJobDeployer(Spec):
    ...
    def arguments(self, arguments):
        class ArgumentsContainer(object):
            ...
            def __getattr__(self, attribute_name):
                if attribute_name in self._arguments:
                    return self._arguments[attribute_name]
                else:
                    attribute_name_underscores_replaced = attribute_name.replace('_', '-')

                    if attribute_name_underscores_replaced in self._arguments:
                        return self._arguments[attribute_name_underscores_replaced]

                    return None

        return ArgumentsContainer(arguments)
    ...
    def set_up(self):
        ...
        self.mock_log_manager.get_logger.return_when(self.mock_logger, 'foundations_contrib.cli.command_line_job_deployer')
    ...
    def test_deploy_returns_correct_error_if_env_not_found_different_name(self):
        self.find_environment_mock.return_value = []
        cli_args = {'entrypoint': 'driver.py', 'env': 'uat'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_exits_the_process_with_exit_status_of_one(self):
        self.find_environment_mock.return_value = []
        cli_args = {'entrypoint': 'driver.py', 'env': 'non-existant-env'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_deploys_job_when_local_config_found(self):
        self.find_environment_mock.return_value = ["home/foundations/lou/config/local.config.yaml"]
        cli_args = {'entrypoint': 'driver.py'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_deploy_returns_error_if_driver_file_does_not_exist(self):
        ...
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': 'hana/driver.py', 'env': 'uat'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_deploy_returns_error_if_driver_file_does_not_have_py_extension(self):
        ...
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': 'hana/driver.exe', 'env': 'uat'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_deploy_imports_driver_file_different_file(self):
        self.os_cwd.return_value = 'home/foundations/lou'
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': 'hippo/dingo.py', 'env': 'uat'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_deploy_imports_driver_file_different_name(self):
        self.os_cwd.return_value = 'home/foundations/lou/'
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': 'passenger.py', 'env': 'uat'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_project_name_is_set_if_provided(self):
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': 'driver.py', 'env': 'uat', 'project-name': self.fake_project_name}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_does_not_append_to_syspath_if_enable_stages_False(self):
        ...
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': self.fake_script_file_name, 'env': 'uat'}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_with_ram_set_sets_amount_of_ram(self):
        ...
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': self.fake_script_file_name, 'env': 'uat', 'ram': self.ram}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_with_num_gpus_set_sets_amount_of_gpus(self):
        ...
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': self.fake_script_file_name, 'env': 'uat', 'num-gpus': self.num_gpus}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_with_both_ram_and_num_gpus_set_sets_both(self):
        ...
        self.find_environment_mock.return_value = ["home/foundations/lou/config/uat.config.yaml"]
        cli_args = {'entrypoint': self.fake_script_file_name, 'env': 'uat', 'ram': self.ram, 'num-gpus': self.num_gpus}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_with_job_directory_chdirs_to_job_directory(self):
        ...
        cli_args = {'job-directory': self.fake_directory}
        CommandLineJobDeployer(self.arguments(cli_args)).deploy()
    ...
    def test_foundations_deploy_with_env_entrypoint_project_name_and_job_directory_set_calls_deploy_with_those_arguments_except_for_job_directory(self):
        ...
        cli_args = {
            'job-directory': self.fake_directory,
            'entrypoint': self.entrypoint,
            'env': self.environment,
            'project-name': self.fake_project_name
        }
