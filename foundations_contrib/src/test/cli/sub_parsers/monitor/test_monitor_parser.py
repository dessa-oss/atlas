...
class TestMonitorParser(Spec):
    ...
    def test_sub_parser_setup_parser_on_cli_instantiation(self):
        mock_add_parser = self.patch('foundations_contrib.cli.sub_parsers.monitor.monitor_parser.MonitorParser.add_sub_parser')
    ...
    def test_monitor_calls_pause_monitor_when_pause_command_is_triggered(self):
        mock_method = self.patch('foundations_contrib.cli.sub_parsers.monitor.monitor_parser.MonitorParser._pause_monitor')
    ...
    def test_monitor_calls_resume_monitor_when_resume_command_is_triggered(self):
        mock_method = self.patch('foundations_contrib.cli.sub_parsers.monitor.monitor_parser.MonitorParser._resume_monitor')
    ...
    def test_monitor_prints_failure_message_when_start_raises_connection_error(self):
