...
class TestInputParameterFormatter(unittest.TestCase):
    ...
    def test_format_input_parameters_one_constant_parameter(self):
        ...
        expected = [{'name': 'owl-1',
                    ...
                    'type': 'string',
                    'source': 'constant'}]
        result = InputParameterFormatter(input_param, job_param,  stage_rank).format_input_parameters()
    ...
    def test_format_input_parameters_one_stage_parameter(self):
        ...
        expected = [{'name': 'ab-1',
                    ...
                    'type': 'string',
                    'source': 'stage'}]
        result = InputParameterFormatter(input_param,{},  stage_rank).format_input_parameters()
        self.assertDictEqual(expected[0], result[0])
    ...
    def test_format_input_parameter_adds_stages_when_stage_time_empty(self):
        ...
        result = InputParameterFormatter(input_param, {}, {}).format_input_parameters()
        self.assertListEqual(expected, result)
    ...
    def test_format_input_parameters_one_unknown_type(self):
        stage_uuid = 'gorilla'
        stage_rank = {'gorilla': 1}
        input_param = [{'argument':{'name': 'ab', 'value': {'value':{}, 'type': 'constant'}}, 'stage_uuid': stage_uuid}]
        expected = [{'name': 'ab-1',
                    'value': 'dict',
                    'type': 'string',
                    'source': 'constant'}]
    ...
    def test_format_input_parameters_input_parameter_array(self):
        stage_uuid = 'gorilla'
        stage_rank = {'gorilla': 1}
        input_param = [{'argument':{'name': 'ab', 'value': {'value':['some_data'], 'type': 'constant'}}, 'stage_uuid': stage_uuid}]
        expected = [{'name': 'ab-1',
                    'value': ['some_data'],
                    'type': 'array string',
                    'source': 'constant'}]
    ...
    def test_format_input_parameters_input_parameter_array_number(self):
        stage_uuid = 'gorilla'
        stage_rank = {'gorilla': 1}
        input_param = [{'argument':{'name': 'ab', 'value': {'value':[5], 'type': 'constant'}}, 'stage_uuid': stage_uuid}]
        expected = [{'name': 'ab-1',
                    'value': [5],
                    'type': 'array number',
                    'source': 'constant'}]
    ...
    def test_format_input_parameters_input_parameter_array_bool(self):
        stage_uuid = 'gorilla'
        stage_rank = {'gorilla': 1}
        input_param = [{'argument':{'name': 'ab', 'value': {'value':True, 'type': 'constant'}}, 'stage_uuid': stage_uuid}]
        expected = [{'name': 'ab-1',
                    'value': True,
                    'type': 'bool',
                    'source': 'constant'}]
