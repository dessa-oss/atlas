...
class TestConsumers(unittest.TestCase):
    ...
    def test_queue_job_consumers(self):
        ...
        self.assertTrue(current_time - project_listing['created_at'] < 0.2)
        ...
        self.assertTrue(current_time - creation_time < 0.2)
    ...
    def test_completed_job_consumers(self):
        ...
        self.assertTrue(current_time - completed_time < 0.2)
    ...
    def test_job_metric_consumers(self):
        ...
        self.assertTrue(current_time - first_job_metric[0] < 0.2)
