...
def dump_all_config_files(advanced, use_specified_version):
    ...
    REDIS_CONTAINER_NAME = str(ask_if_advanced(advanced, "The name of the Tracker container", "atlas-ce-tracker"))
    ...
    ARCHIVE_CONTAINER_NAME = str(ask_if_advanced(advanced, "The name of the archive server container", "atlas-ce-archive-server"))
    ...
    SCHEDULER_CONTAINER_NAME = str(ask_if_advanced(advanced, "The name of the scheduler container", "atlas-ce-local-scheduler"))
    ...
    SERVICE_CONFIG_PATH = FOUNDATIONS_HOME / 'config' / 'service.config.yaml'
