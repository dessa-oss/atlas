...
source devops/teardown_frontend_dev_orbit.sh
...
cd ../local_docker_scheduler && python -m local_docker_scheduler -p ${SCHEDULER_PORT} > $FOUNDATIONS/logs/scheduler.log 2>&1 &
