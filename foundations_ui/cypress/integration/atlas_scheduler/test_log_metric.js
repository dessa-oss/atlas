  ...
  const states = [
    {
      ...
      command: `export FOUNDATIONS_HOME=\`pwd\`/cypress/fixtures/atlas_scheduler/.foundations && cd cypress/fixtures/atlas_scheduler/log_metric/ && foundations login http://localhost:5558 -u test -p test && foundations submit scheduler ${projectName} ints.py`,
    },
    {
      ...
      command: `export FOUNDATIONS_HOME=\`pwd\`/cypress/fixtures/atlas_scheduler/.foundations && cd cypress/fixtures/atlas_scheduler/log_metric/ && foundations login http://localhost:5558 -u test -p test && foundations submit scheduler ${projectName} floats.py`,
    },
    {
      ...
      command: `export FOUNDATIONS_HOME=\`pwd\`/cypress/fixtures/atlas_scheduler/.foundations && cd cypress/fixtures/atlas_scheduler/log_metric/ && foundations login http://localhost:5558 -u test -p test && foundations submit scheduler ${projectName} strs.py`,
    },
  ];
