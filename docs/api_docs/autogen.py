...
PAGES = [
    ...
    {
        'page': 'load_parameters.md',
        'all_module_classes': [foundations],
        'functions': [
    ...
    {
        'page': 'deploy.md',
        'all_module_classes': [foundations.deploy],
        'functions': [
            foundations.deploy,
        ]
    },
...
def class_to_source_link(cls):
    ...
    link = 'https://github.com/DeepLearnI/foundations/blob/master/' + path + '#L' + str(line)
    return '[[source]](' + link + ')'
