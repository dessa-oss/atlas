...
from foundations_core_rest_api_components.v1.controllers.session_controller import SessionController
...
class TestSessionController(Spec):
    ...
    mock_auth = let_patch_mock('foundations_core_rest_api_components.v1.models.session.Session.auth')
    mock_create = let_patch_mock('foundations_core_rest_api_components.v1.models.session.Session.create')
