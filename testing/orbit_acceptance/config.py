...
def set_foundations_home():
    import os
    os.environ['FOUNDATIONS_HOME'] = os.path.abspath(os.environ.get('FOUNDATIONS_HOME', os.path.join(os.getcwd(), 'orbit_acceptance/fixtures/end-to-end-acceptance/foundations_home')))
...
def _flattened_config_walk():
    ...
    for dir_name, _, files in os.walk(os.environ['FOUNDATIONS_HOME']):
