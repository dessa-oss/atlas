...
class TestSetJobResources(Spec):
    ...
    def test_job_is_run_with_default_resources_when_resources_not_set(self):
        ...
        get_ram_in_mb = foundations.create_stage(get_ram_in_gb_when_limit_not_set)
        stage_get_ram_in_gb = get_ram_in_gb()
    ...
    def test_excpetion_thrown_when_job_is_run_with_too_many_resources(self):
        ...
        error_message = 'Could not deploy job - resources requested exceeds capacity of largest node'
