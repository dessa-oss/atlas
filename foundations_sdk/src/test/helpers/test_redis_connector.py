...
class TestRedisConnector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._connector = RedisConnector(self._config_manager, self._connection_callback)

    def test_call_calls_callback_with_connection_string_missing(self):
        self._connector()
        self._connection_callback.assert_called_once_with('redis://localhost:6379')
    ...
    def test_call_calls_callback_with_connection_string_different_connection(self):
        ...
        self._connector()
        self._connection_callback.assert_called_once_with('redis://feifei:9733')
