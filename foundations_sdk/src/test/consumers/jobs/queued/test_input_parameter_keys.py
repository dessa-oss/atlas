...
class TestInputParameterKeys(unittest.TestCase):
    ...
    def test_call_saved_run_data_keys(self):
        ...
        self._consumer.call({'project_name': 'here be dragons', 'input_parameters': input_parameters}, None, None)
    ...
    def test_call_saved_run_data_keys_multiple_keys(self):
        input_parameters = [
            {'argument': {'name': 'shown_layers', 'value': 7777}, 'stage_uuid': 'stage1'},
    ...
    def test_call_saved_run_data_keys_different_project_name(self):
        input_parameters = [{'argument': {'name': 'hidden_layers', 'value': 7777}, 'stage_uuid': 'stage1'}]
        self._consumer.call({'project_name': 'here be sheep', 'input_parameters': input_parameters}, None, None)
