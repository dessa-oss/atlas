...
class TestExceptionHookMiddleware(unittest.TestCase):
    ...
    def test_good_callback_preserves_excepthook(self):
        ...
        args = [43]
        kwargs = {"asdf": 57}
        result = self._exception_hook_middleware.call(None, None, None, args, kwargs, good_boi)
    ...
    def test_bad_callback_changes_excepthook(self):
        ...
        try:
            self._exception_hook_middleware.call(None, None, None, args, kwargs, bad_boi)
