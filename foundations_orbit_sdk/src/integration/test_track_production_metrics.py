...
class TestTrackProductionMetrics(Spec):
    ...
    def set_up(self):
        ...
        os.environ['MODEL_NAME'] = 'some_model_name'
    ...
    def test_track_production_metrics_stores_metrics_in_redis(self):
        ...
        production_metrics_from_redis = self._redis.hgetall('projects:some_project_name:models:some_model_name:production_metrics')
