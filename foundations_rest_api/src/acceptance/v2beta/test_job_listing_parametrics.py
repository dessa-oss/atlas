...
class TestJobListingParametrics(APIAcceptanceTestCaseBase):
    ...
    def _run_stages(klass):
        ...
        p.start()
        p.join()
        p = Process(target=run_third_job)
        p.start()
        p.join()
    ...
    def test_get_route(self):
        ...
        self.assertEqual(data['jobs'][0]['input_params'][0]['name'], 'value1-5')
        self.assertEqual(data['jobs'][0]['input_params'][1]['name'], 'value2-5')
        self.assertEqual(data['jobs'][0]['input_params'][2]['name'], 'value1-6')
        self.assertEqual(data['jobs'][0]['input_params'][3]['name'], 'value2-6')
        self.assertEqual(data['jobs'][0]['input_params'][4]['name'], 'value3-6')
        self.assertEqual(data['jobs'][0]['input_params'][0]['value'], 30)
        self.assertEqual(data['jobs'][0]['input_params'][1]['value'], 'some string')
        self.assertEqual(data['jobs'][0]['input_params'][2]['value'], 'stage0-2')
        self.assertEqual(data['jobs'][0]['input_params'][3]['value'], 'stage1-5')
        self.assertEqual(data['jobs'][0]['input_params'][4]['value'], 3.14)
        ...
        self.assertEqual(data['jobs'][1]['input_params'][0]['name'], 'value1-3')
        self.assertEqual(data['jobs'][1]['input_params'][1]['name'], 'value2-3')
        self.assertEqual(data['jobs'][1]['input_params'][2]['name'], 'value1-4')
        self.assertEqual(data['jobs'][1]['input_params'][3]['name'], 'value2-4')
        self.assertEqual(data['jobs'][1]['input_params'][4]['name'], 'value3-4')
        self.assertEqual(data['jobs'][1]['input_params'][0]['value'], 20)
        self.assertEqual(data['jobs'][1]['input_params'][1]['value'], None)
        self.assertEqual(data['jobs'][1]['input_params'][2]['value'], 'stage0-2')
        self.assertEqual(data['jobs'][1]['input_params'][3]['value'], 'stage1-3')
        self.assertEqual(data['jobs'][1]['input_params'][4]['value'], 8.3)
        ...
        self.assertEqual(data['jobs'][2]['input_params'][0]['name'], 'value1-0')
        self.assertEqual(data['jobs'][2]['input_params'][1]['name'], 'value2-0')
        self.assertEqual(data['jobs'][2]['input_params'][2]['name'], 'value1-1')
        self.assertEqual(data['jobs'][2]['input_params'][3]['name'], 'value2-1')
        self.assertEqual(data['jobs'][2]['input_params'][4]['name'], 'value3-1')
        self.assertEqual(data['jobs'][2]['input_params'][0]['value'], 10)
        # This "NoneType" must be changed to None when bug is addressed in FOUND-715
        self.assertEqual(data['jobs'][2]['input_params'][1]['value'], 'NoneType')
        self.assertEqual(data['jobs'][2]['input_params'][2]['value'], 'stage0-2')
        self.assertEqual(data['jobs'][2]['input_params'][3]['value'], 'stage1-0')
        self.assertEqual(data['jobs'][2]['input_params'][4]['value'], 5)

        self.assertIsNone(data['jobs'][2]['output_metrics'][0]['value'])
        self.assertIsNone(data['jobs'][2]['output_metrics'][1]['value'])
