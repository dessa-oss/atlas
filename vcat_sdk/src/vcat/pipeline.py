...
class Pipeline(object):
    ...
    def __init__(self, pipeline_context):
        ...
        self._stage_smart_constructor = StageSmartConstructor(self.pipeline_context)
    ...
    def stage(self, function, *args, **kwargs):
        ...
        return StageConnectorWrapper(self.graph.stage(current_stage), self.pipeline_context, self._stage_smart_constructor)
    ...
    def join(self, upstream_connector_wrappers, function, *args, **kwargs):
        ...
        current_stage = self._stage_smart_constructor.make_stage(
            function, *args, **kwargs)
        return StageConnectorWrapper(self.graph.join(current_stage, upstream_connectors), self.pipeline_context, self._stage_smart_constructor)
