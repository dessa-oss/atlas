...
class PipelineArchiverFetch(object):
    ...
    def __init__(self, archive_listing, stage_log_archive, persisted_data_archive, provenance_archive, job_source_archive, artifact_archive, miscellanous_archive):
    ...
    def fetch_archivers(self):
        ...
        return [PipelineArchiver(name, self._archive_listing, self._stage_log_archive, self._persisted_data_archive, self._provenance_archive, self._job_source_archive, self._artifact_archive, self._miscellanous_archive) for name in job_names]
