...
class StageConnectorWrapper(object):
    ...
    def stage(self, function, *args, **kwargs):
        ...
        stage_hierarchy.add_entry(new_stage.uuid(), new_stage.function_name(), parent_uuids, new_stage.function_source_code(), new_stage.source_file(), new_stage.source_line(), new_stage.stage_args())
